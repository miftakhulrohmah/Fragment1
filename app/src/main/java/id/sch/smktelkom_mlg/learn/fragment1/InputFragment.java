...
public class InputFragment extends Fragment {
    ...
    private void doProsess() {
        if (mListener != null){
            mListener.doProsess(etNama.getText().toString(), etUmur.getText().toString());
        }
    }
    ...
    public void onAttach(Context context){
        ...
        if(context instanceof InputFragment.IListener){
            ...
            throw new RuntimeException(context.toString()+" must implements.IListener");
        }
    }
    ...
    public interface IListener{
        void doProsess(String nama, String umur);
    }
